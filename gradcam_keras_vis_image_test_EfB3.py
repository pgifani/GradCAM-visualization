...
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_efficientnetB3.hdf5"
...
num_classes=3
conv_layer_name="conv2d_104" 
s=300


def load_model():
    base_model = EfficientNetB3(input_shape=(s,s,3), weights='imagenet', include_top=False)
