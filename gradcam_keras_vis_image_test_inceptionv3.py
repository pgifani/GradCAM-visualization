...
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_InceptionV3.hdf5"
...
CLASS_INDEX = json.load(open("G:/Vafaeezadeh/data/99-5-28/vafa_class_index.json"))
#CLASS_INDEX = json.load(open("G:/DataBase/imagenet/imagenet_class_index.json"))
...
paretn_root="G:/Vafaeezadeh/data/99-5-28/gradcam/corrects/III/"
im_name="III_ASYABI_RAHMAN_image_00020.jpg"
