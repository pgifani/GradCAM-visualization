...
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_ResNeXt50.hdf5"
...
num_classes=4
conv_layer_name="stage4_unit3_conv3" 
s=224


def load_model():
    base_model = ResNeXt50(input_shape=(s,s,3), weights='imagenet', include_top=False)
