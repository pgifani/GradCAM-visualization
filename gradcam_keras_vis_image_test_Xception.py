...
model_name='Xception'   
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_Xception.hdf5"
...
num_classes=4
conv_layer_name="block14_sepconv2" 
s=299


def load_model():
    base_model = Xception(input_shape=(s,s,3), weights='imagenet', include_top=False)
