...
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_NASNetMobile.hdf5"
...
num_classes=3
conv_layer_name="normal_conv_1_12" 
s=224


def load_model():
    base_model = NASNetMobile(input_shape=(s,s,3), weights='imagenet', include_top=False)
