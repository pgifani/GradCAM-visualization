...
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_efficientnetB1.hdf5"
...
def load_model():
    base_model = EfficientNetB1(input_shape=(s,s,3), weights='imagenet', include_top=False)
