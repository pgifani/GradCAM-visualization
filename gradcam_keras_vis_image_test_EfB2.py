...
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_efficientnetB2.hdf5"
...
num_classes=3
conv_layer_name="conv2d_92" 
s=260


def load_model():
    base_model = EfficientNetB2(input_shape=(s,s,3), weights='imagenet', include_top=False)
