...
root="./model_path/"
model_weights_path = root + model_name + "/" + "model_.05-0.63_4class_efficientnetB0.hdf5"
...
num_classes=4
conv_layer_name="conv2d_65" 
s=224


def load_model():
    base_model = EfficientNetB0(input_shape=(s,s,3), weights='imagenet', include_top=False)
